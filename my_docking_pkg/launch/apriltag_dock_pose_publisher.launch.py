...
def generate_launch_description():
    ...
    package_name_docking = 'my_docking_pkg'
    ...
    # Launch configuration variablesTURTLEBOT3_MODEL
   ...
   # Create the detected dock pose publisher node
    ...
    # Create the static transform publisher for camera
    camera_transform_publisher = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='camera_link_broadcaster',
        arguments=['-0.032', '0', '0.182', '0', '0', '0', 'base_link', 'camera_link']
    )
    ...
    # Add the container and nodes
    ld.add_action(camera_transform_publisher)  # Add this line
